...
public:
	...
	// Get mass/energy
	QEnergy						getEnergyRest()						const;
	QEnergy						getEnergyKinetic()					const;
	QEnergy						getEnergyTotal()					const;
	QMass						getMassRest()						const;
	QMass						getMassEffective()					const;
	...
	// Friend functions
	friend QLength				distance(const cObject&, const cObject&);
